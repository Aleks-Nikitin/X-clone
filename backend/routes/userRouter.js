...
userRotuer.get("/all",userController.getAllUsers);
userRotuer.get("/:userId/following", userController.getUserFollowing);
userRotuer.get("/:userId/followers", userController.getUserFollowers);
